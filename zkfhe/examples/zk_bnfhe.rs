...
use fhe_core::{
    and, majority, nand, nor, not, or, xnor, xor, LWECiphertext, LWEModulusType, NTRUSecretKeyPack,
};
use rand::Rng;
use zkfhe::ntru_bfhe::{
    Decryptor, Encryptor, Evaluator, DEFAULT_TERNARY_128_BITS_NTRU_PARAMERTERS,
};
...
fn main() {
    ...
    // set parameter
    let params = DEFAULT_TERNARY_128_BITS_NTRU_PARAMERTERS.clone();
    ...
    // generate keys
    let sk = NTRUSecretKeyPack::new(params);
