...
impl<C: UnsignedInteger, LweModulus: RingReduce<C>, Q: NttField> Clone
    for CmpFheParameters<C, LweModulus, Q>
{
    #[inline]
    fn clone(&self) -> Self {
        *self
...
impl<C: UnsignedInteger, LweModulus: RingReduce<C>, Q: NttField>
    CmpFheParameters<C, LweModulus, Q>
{
    ...
    /// Returns the LWE dimension of this [`CmpFheParameters<C, Q>`], refers to **n** in the paper.
    #[inline]
    pub fn lwe_dimension(&self) -> usize {
        self.lwe_params.dimension
    }

    /// Returns the LWE message modulus of this [`CmpFheParameters<C, Q>`], refers to **t** in the paper.
    #[inline]
    pub fn lwe_plain_modulus(&self) -> C {
        self.lwe_params.plain_modulus_value
    }

    /// Returns the LWE cipher modulus of this [`CmpFheParameters<C, Q>`], refers to **q** in the paper.
    #[inline]
    pub fn lwe_cipher_modulus(&self) -> LweModulus {
        self.lwe_params.cipher_modulus
    }

    /// Returns the LWE cipher modulus value of this [`CmpFheParameters<C, Q>`], refers to **q** in the paper.
    #[inline]
    pub fn lwe_cipher_modulus_value(&self) -> ModulusValue<C> {
        self.lwe_params.cipher_modulus_value
    }

    /// Returns the LWE cipher modulus minus one of this [`CmpFheParameters<C, Q>`], refers to **q-1** in the paper.
    #[inline]
    pub fn lwe_cipher_modulus_minus_one(&self) -> C {
        self.lwe_params.cipher_modulus_minus_one
    }

    /// Returns the LWE noise error's standard deviation of this [`CmpFheParameters<C, Q>`].
    #[inline]
    pub fn lwe_noise_standard_deviation(&self) -> f64 {
        self.lwe_params.noise_standard_deviation
    }

    /// Returns the LWE Secret Key distribution Type of this [`CmpFheParameters<C, Q>`].
    #[inline]
    pub fn lwe_secret_key_type(&self) -> LweSecretKeyType {
        self.lwe_params.secret_key_type
    }

    /// Returns the ring dimension of this [`CmpFheParameters<C, Q>`], refers to **N** in the paper.
    #[inline]
    pub fn ring_dimension(&self) -> usize {
        self.blind_rotation_params.dimension
    }

    /// Returns the ring modulus of this [`CmpFheParameters<C, Q>`], refers to **Q** in the paper.
    #[inline]
    pub fn ring_modulus(&self) -> <Q as Field>::ValueT {
        self.blind_rotation_params.modulus
    }

    /// Returns the ring noise error's standard deviation of this [`CmpFheParameters<C, Q>`].
    #[inline]
    pub fn ring_noise_standard_deviation(&self) -> f64 {
        self.blind_rotation_params.noise_standard_deviation
    }

    /// Returns the ring secret key type of this [`CmpFheParameters<C, Q>`].
    #[inline]
    pub fn ring_secret_key_type(&self) -> RingSecretKeyType {
        self.blind_rotation_params.secret_key_type
    }

    /// Returns the gadget basis of this [`CmpFheParameters<C, Q>`],
    ...
    /// Returns the key switching basis' bits of this [`CmpFheParameters<C, Q>`],
    ...
    /// Returns the key switching error's standard deviation of this [`CmpFheParameters<C, Q>`].
    #[inline]
    ...
    /// Returns the steps of whole bootstrapping of this [`CmpFheParameters<C, Q>`].
    #[inline]
    pub fn steps(&self) -> Steps {
        self.steps
    }

    /// Returns a reference to the lwe params of this [`CmpFheParameters<C, Q>`].
    #[inline]
    ...
    /// Returns the key switching params of this [`CmpFheParameters<C, Q>`].
    #[inline]
