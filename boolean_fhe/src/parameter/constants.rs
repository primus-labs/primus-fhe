...
use algebra::{
    modulus::{NativeModulus, PowOf2Modulus},
    reduce::ModulusValue,
    Field, U32FieldEval,
};
...
pub static NO_KEY_SWITCHING: LazyLock<BooleanFheParameters<u16, NativeModulus<u16>, Fp>> =
    LazyLock::new(|| {
        BooleanFheParameters::<u16, NativeModulus<u16>, Fp>::new(ConstParameters {
            lwe_dimension: 1024,
            lwe_plain_modulus: 4,
            lwe_cipher_modulus: ModulusValue::Native,
            lwe_noise_standard_deviation: 3.20,
            lwe_secret_key_type: LweSecretKeyType::Binary,
            ring_dimension: 1024,
            ring_modulus: Fp::MODULUS_VALUE,
