...
impl<F: Field> BitDecompositionSubClaim<F> {
    ...
    pub fn verify_subclaim(
        &self,
        d_val: &Vec<Rc<DenseMultilinearExtension<F>>>,
        d_bits: &Vec<Vec<Rc<DenseMultilinearExtension<F>>>>,
        u: &[F],
